...
import { COMMUNITY_PAGE_COPY } from "@/data/communityData";
...
export function CommunityPageHero({ onWrite, onGuide }: CommunityPageHeroProps) {
  return (
